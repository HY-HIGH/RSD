...
class ObjectDetector():
    ...
    def detect_objects(self, frame):
        #time1 = time.time()#time 을 찍어주는 함수 
       ...
       # time4 = time.time()
        ...
        # print("%0.3f, %0.3f, %0.3f sec" % (time2 - time1, time3 - time2, time4 - time1))
...
if __name__ == '__main__':
    ...
    while True:   
        ...
        print("----------------------------------------------")
        #print("no.%d"%(count_frame))
        time_start = time.time()#시작지점 시간 계산.
        frame = cam.get_frame()
        ...
        time_end = time.time()#끝 지점 시간 계산.
        #print("FPS: %0.3f" % (1/(time_end - time_start)))
        #print("----------------------------------------------")
